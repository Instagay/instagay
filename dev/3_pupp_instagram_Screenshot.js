...
const log = (indentlevel, msg) => {
    process.stdout.write("    ".repeat(indentlevel) + msg);
}

var scroll_to_bottom = async(args) => {
...
var get_recent_posts_from_page = async(args) =>  {
...
var get_location_coordinates = async (args) => {
